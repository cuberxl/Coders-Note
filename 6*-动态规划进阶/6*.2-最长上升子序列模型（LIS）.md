...
- 分析：
	...
	- 状态转移：$f[i] = \max(f[i], f[j] + 1) \quad (0 \le j < i, \; a[j] < a[i])$
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwNzk4MzkwMSwtMTkxMzAyNTcwLC0xNT
IwNDkyOTMwLC0xNTMxNDA5NzY0LC05NDUxMDk3NzEsLTE2Nzc1
OTI2OTIsLTE1ODk4ODU4MzVdfQ==
-->